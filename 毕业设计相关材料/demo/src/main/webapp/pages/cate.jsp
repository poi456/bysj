...
<html class="x-admin-sm">
  ...
  <body>
    ...
    <div class="x-body">
      ...
      <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加员工','<%=request.getContextPath()%>/pages/Gysadd.jsp',600,400)"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table layui-form">
        ...
        <c:forEach items="${findAll}" var="account">
          ...
          <tr cate-id='1' fid='0' >
            ...
            <td class="td-manage">
              <a class="layui-btn layui-btn layui-btn-xs" href="<%=request.getContextPath()%>/pages/GysUpda.jsp" ><i class="layui-icon">&#xe640;</i>编辑</a>
